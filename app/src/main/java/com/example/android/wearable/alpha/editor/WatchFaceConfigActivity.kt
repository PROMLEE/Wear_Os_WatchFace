...
import com.example.android.wearable.alpha.utils.COMPLICATION1_ID
import com.example.android.wearable.alpha.utils.COMPLICATION2_ID
import com.example.android.wearable.alpha.utils.COMPLICATION3_ID
import com.example.android.wearable.alpha.utils.COMPLICATION4_ID
import com.example.android.wearable.alpha.utils.COMPLICATION5_ID
import com.example.android.wearable.alpha.utils.COMPLICATION6_ID
import com.example.android.wearable.alpha.utils.COMPLICATION7_ID
import com.example.android.wearable.alpha.utils.COMPLICATION8_ID
...
class WatchFaceConfigActivity : ComponentActivity() {
    ...
    fun onClickComplication1Button(view: View) {
        ...
        stateHolder.setComplication(COMPLICATION1_ID)
    }
    fun onClickComplication2Button(view: View) {
        Log.d(TAG, "onClickLeftComplicationButton() $view")
        stateHolder.setComplication(COMPLICATION2_ID)
    }
    fun onClickComplication3Button(view: View) {
        Log.d(TAG, "onClickLeftComplicationButton() $view")
        stateHolder.setComplication(COMPLICATION3_ID)
    }
    fun onClickComplication4Button(view: View) {
        Log.d(TAG, "onClickLeftComplicationButton() $view")
        stateHolder.setComplication(COMPLICATION4_ID)
    }
    fun onClickComplication5Button(view: View) {
        Log.d(TAG, "onClickLeftComplicationButton() $view")
        stateHolder.setComplication(COMPLICATION5_ID)
    }
    fun onClickComplication6Button(view: View) {
        Log.d(TAG, "onClickLeftComplicationButton() $view")
        stateHolder.setComplication(COMPLICATION6_ID)
    }
    fun onClickComplication7Button(view: View) {
        Log.d(TAG, "onClickLeftComplicationButton() $view")
        stateHolder.setComplication(COMPLICATION7_ID)
    }
    fun onClickComplication8Button(view: View) {
        Log.d(TAG, "onClickLeftComplicationButton() $view")
        stateHolder.setComplication(COMPLICATION8_ID)
    }
